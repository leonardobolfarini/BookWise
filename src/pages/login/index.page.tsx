    ...
    return (
        <LoginContainer>
            <LoginBannerContainer>
                <Image src={LoginBannerImage} alt="Login Banner" width={598} height={912} priority />
            </LoginBannerContainer>
            <LoginOptionsContainer>
                ...
                >Entrar com Google</LoginCard>
                <LoginCard
                    ImageLogo={GithubLogo}
                    href='#'
                    disabled={isNavigating}
                    onClick={() => handleSignIn('github')}
                >Entrar com Github</LoginCard>
                <LoginCard
                    ImageLogo={RocketLaunch}
                    href='/'
                    disabled={isNavigating}
                    onClick={() => handleSignIn('guest')}
                >Acessar como visitante</LoginCard>
            </LoginOptionsContainer>
        </LoginContainer>
    )
}