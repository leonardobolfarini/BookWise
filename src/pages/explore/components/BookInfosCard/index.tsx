...
export function BookInfosCard({ id, title, author, averageRating, categories, pages, cover_url, Rating }: BookProps) {
        ...
        <BookInfosCardContainer id={id}>
            ...
            <CategoryAndPagesContainer>
                <CategoryAndPages>
                    ...
                    <div>
                        <h2>Categoria</h2>
                        <span>{categoriesName?.map((category) => category.name).join(', ')}</span>
                    </div>
                </CategoryAndPages>
                <CategoryAndPages>
